...
|                |ManageAuthor   |Управление авторами               |(Блокировка, Разблокировка)                                    | 07.12.2024|  В процессе   |
|                |Article        |Поиск статьи                      | Поиск по автору                                               |           |  Готово       |
|                |               |                                  | Поиск по рейтингу                                             |           |  В процессе   |
...
|                |               |                                  | Жалоба                                                        |10.12.2024 |  В процессе   |
|                |ManageComment  |Управление комментами             |(Просмотр жалоб, Удаление комментария)                         |11.12.2024 |  В процессе   |
| Тестирование   | Все           | Исправление багов                |Рефакторинг                                                    | 12.12.2024|  В процессе   |
